...
import { validInput, validEmail, validRut, validDate, validHour } from "./verify/index.js"
...
const registerDate = (stream) => {
    ...
    const date = validInput("Ingrese la fecha de la cita en formato DD/MM/YYYY: ", validHour)
    const hour = validInput("Ingrese la hora de la cita en formato HH:MM: ", validHour)
